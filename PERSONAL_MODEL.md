...
id: mindcap-personal-model
title: Mindcap Personal Model
...
Mindcap is designed for and operated by people even when it is primarily a library or automation surface. This document makes its limited human assumptions explicit; it is not a persona catalog, diagnosis, identity model, or prediction engine.

## People in scope

- people preserving their digital context
- researchers
- Mindgarden consumers
- automation processing verified source bundles
